    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.vicariate.update', $vicariate->id) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="diocese" id="diocese" class="select2 form-select">
                                    ...
                                    @forelse ($dioceses as $diocese)
                                        <option value="{{ $diocese->id }}"
                                            {{ $vicariate->diocese == $diocese->id ? 'selected' : null }}>
                                            {{ $diocese->name }}</option>
                                    @empty
