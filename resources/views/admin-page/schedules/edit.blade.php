    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title fw-semibold">Edit Schedule</h4>
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.confession_schedule.update', $schedule->id) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="church_uuid" id="church_uuid" class="form-control select2">
                                    @foreach ($churches as $church)
                                        <option {{ $church->church_uuid == $schedule->church_uuid ? 'selected' : null }} value="{{ $church->church_uuid }}">{{ $church->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="schedule_date" name="schedule_date" aria-describedby="scheduleDateHelp" value="{{ $schedule->schedule_date }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="started_time" name="started_time" aria-describedby="startedTimeHelp" value="{{ $schedule->started_time }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="end_time" name="end_time" aria-describedby="endTimeHelp" value="{{ $schedule->end_time }}">
                                <span class="text-danger danger">@error('end_time'){{ $message }}@enderror</span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ $schedule->is_active ? 'checked' : null }}>
