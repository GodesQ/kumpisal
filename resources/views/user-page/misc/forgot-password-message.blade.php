...
@section('content')
    <div class="container d-flex align-items-center justify-content-center" style="height: 40vh;">
        <div class="d-flex justify-content-center align-items-center bg-white border-success-3 my-2 p-5 flex-column verify-box"
            style="border: 2px solid #303030;">
            <img class="brand-logo my-2" alt="kumpisalan"
                src="{{ URL::asset('user-assets/images/assets/dark-kumpisalan.png') }}" width="200">
